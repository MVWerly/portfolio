...
const About = () => (
  <section>
    ...
    <Paragraph>
      ...
      Id labore saepe dignissimos aspernatur. Impedit saepe officiis
      laudantium cumque ducimus hic tempore perspiciatis provident,
      repellat veniam. Enim a repellendus cumque? Tenetur?
    </Paragraph>
    <GithubSection>
